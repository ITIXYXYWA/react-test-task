...
export const selectProductStatusById = (state, id) => state.product.statusById[id]
...
export const selectStatusProductColorById = (state, productId, colorId) => state.product.statusProductIdToColor?.[productId]?.[colorId]